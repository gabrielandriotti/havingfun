...
# plt.imshow(x_train_orig[550,1:28,1:28])
# y_train_orig[550] 
...
plt.imshow(x_test_orig[1157,1:28,1:28])
y_test_orig[1100] 

pred[1100]

pd.crosstab(y_test_orig, pred)




# como predizer um novo numero

im = sp.imread("C:\\Users\\gabriel_andriotti\\Desktop\\PYTHON scripts\\numeros\\imagem.png",mode='F')/255
pred_new = model.predict_classes(im.reshape(1, 28, 28, 1), verbose=0)
pred_new[0]
